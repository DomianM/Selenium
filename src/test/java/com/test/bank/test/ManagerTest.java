...
//        driver.get("https://www.globalsqa.com/angularJs-protractor/BankingProject/#/login");
        ...
        loginBankPage.clickBankManagerButton();
        ManagerPage managerPage=new ManagerPage(driver);
        managerPage.validateAddingCustomerFunctionality(driver,ConfigReader.readProperty("QA_firstName"),ConfigReader.readProperty("QA_lastName"),ConfigReader.readProperty("QA_postCode"),
